...
\input{songs/komin_a_brizy}
\input{songs/pisen_o_lasce}
\input{songs/prijdes_domu}
\input{songs/laska}
\input{songs/pole_trava_cinzaky}
\input{songs/v_jezere_mleka_a_mlhy}
\input{songs/boty_proti_lasce}
